 ...
 * {@link year2.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link year2#newInstance} factory method to
 * create an instance of this fragment.
 */
public class year2 extends Fragment implements AdapterListSubject.myListener{
     ...
     * @return A new instance of fragment year2.
     */
    // TODO: Rename and change types and number of parameters
    public static year2 newInstance(String param1, String param2) {
        year2 fragment = new year2 ( );
    ...
    private ArrayList<modelClass> dataqueue(String subject) {
        ...
        if(subject.equalsIgnoreCase ("Computer")){
            ...
            ob1.setTv_rec ("Object Oriented Programming in C++");
            holder.add(ob1);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate (R.layout.fragment_year2, container, false);
